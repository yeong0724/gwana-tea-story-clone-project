...
const Footer = () => {
  return (
    <footer className="relative z-[60] w-full bg-[#F9F9F9] border-t border-gray-200 min-h-[200px] py-8">
          ...
          <div className="flex flex-wrap flex-col items-center gap-2 leading-relaxed text-[15px]">
            ...
            <div>
              <span className="text-gray-500">
                Copyright © Ganna Tea House. All rights reserved. Designed by Jin-yeong Kim
              </span>
            </div>
          </div>
        </div>
        <div className="md:hidden flex flex-col space-y-4 text-sm text-gray-700">
          ...
          <div className="flex flex-wrap flex-col items-start gap-2 leading-relaxed text-[15px]">
            ...
            <div className="flex flex-col items-start">
              ...
              <span className="text-gray-500">Designed by Jin-yeong Kim</span>
            </div>
          </div>
        </div>
      </div>
